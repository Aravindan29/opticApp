...
import { LangCountryParamList } from '../appTypes';

const LangCountryInitialStack = createStackNavigator<LangCountryParamList>();
...
export default function LangCountryNavigation() {
  return (
    <LangCountryInitialStack.Navigator initialRouteName="LANGCOUNTRY" screenOptions={{ gestureEnabled: true, headerShown: false, ...transitionConfig }}>
      <LangCountryInitialStack.Screen
        name="LANGCOUNTRY"
        options={{ headerShown: false }}
        component={LanguageCountryScreen}
      />
    </LangCountryInitialStack.Navigator>
  );
}